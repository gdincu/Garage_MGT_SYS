...
if (isset($_POST['submit'])) {
  if ($result && $statement->rowCount() > 0) { 
    ...
    echo "<div class=\"col\">";
    echo "<input type=\"text\" class=\"form-control\" id=\"nume1\" name=\"nume1\" value = " . $row["nume"] . " required>";
    echo "</div>";
    echo "<div class=\"col\">";
    echo "<input type=\"text\" class=\"form-control\" id=\"prenume1\" name=\"prenume1\" value = " . $row["prenume"] ." required>";
    echo "</div>";
    echo "</div>";
    echo "</p>";
    ...
    echo "<div class=\"form-row\">";
    echo "<div class=\"col\">";
    echo "<input type=\"text\" class=\"form-control\" id=\"nrtelefon1\" name=\"nrtelefon1\" value = " . $row["nrtelefon"] . " title=\"Nu se poate modifica.\">";
    echo "</div>";
    echo "<div class=\"col\">";
    echo "<input type=\"email\" class=\"form-control\" id=\"email1\" name=\"email1\" value = " . $row["email"] . " required>";
    echo "</div>";
    echo "<div class=\"col\">";
    echo "<input type=\"text\" class=\"form-control\" id=\"adresa1\" name=\"adresa1\" value = " . $row["adresa"] . " required>";
    echo "</div>";
    echo "</p>";
    ...
    echo "<div class=\"form-row\">";
    echo "<div class=\"col\">";
    echo "<input type=\"text\" class=\"form-control\" id=\"observatii1\" name=\"observatii1\" value = " . $row["observatii"] . " required>";
    echo "</div>";
    echo "</p>";

    echo "<div class=\"form-row\">";
    echo "<div class=\"col\">";
    echo "<button type=\"submit\" name=\"submit1\" class=\"btn btn-primary\">Modifica</button>";
    echo "</div>";
    echo "</div>";
